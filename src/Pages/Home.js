...
export const Home = () => {
  ...
  const showCards = loading ? <h1>Loading</h1> : movies.map(movie => {
    return <MovieCard movie={movie} />
  })

  return (
    <div className="App">
      <div class="container">{showCards}</div>
      ...
      <div class="container mb-10 mt-4" role="group">
        ...
        <button type="button" class="py-2 px-4 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200">
          {page}
        </button>
